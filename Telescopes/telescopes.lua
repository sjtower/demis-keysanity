...
local function activate()
    ...
    hud_callback = set_callback(function(ctx)
        ...
        if not at_bottom then
            ctx:draw_text("\u{8E}", 0, -buttonsy + 0.1 + hud_button_insets.bottom, buttonssize, buttonssize, Color:white(), VANILLA_TEXT_ALIGNMENT.CENTER, VANILLA_FONT_STYLE.BOLD)
        end
